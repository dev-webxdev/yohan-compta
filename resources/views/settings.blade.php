...
<form method="post" action="{{ route('settings.database.backups.restore', ['backup' => $backup['name']]) }}" onsubmit="return confirm('Restaurer cette sauvegarde ? L’état actuel sera remplacé sans créer de nouvelle sauvegarde automatique.')">@csrf
